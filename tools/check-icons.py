#!/usr/bin/env python3
"""
Every committed icon is what tools/make-icons.py cuts from the committed source.

WHAT THIS IS FOR. Sixteen PNGs are generated from one render, and nothing else
